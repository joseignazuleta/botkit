...
function Facebookbot(configuration) {
    ...
    facebook_botkit.createWebhookEndpoints = function(webserver, bot, cb) {
        ...
        facebook_botkit.log('** the port is: ' + facebook_botkit.config.port);
        facebook_botkit.log('** The configuration token is: ' + configuration.access_token);
        facebook_botkit.log('** The verify token is: ' + configuration.verify_token);
